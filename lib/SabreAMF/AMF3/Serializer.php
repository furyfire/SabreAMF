...
class Serializer extends \SabreAMF\Serializer
{
    ...
    public function writeAMFData($data, $forcetype = null)
    {
        ...
        switch ($type) {
            ...
            case Constants::DT_NULL : break;
            case Constants::DT_BOOL_FALSE : break;
            case Constants::DT_BOOL_TRUE : break;
            case Constants::DT_INTEGER : $this->writeInt($data);
                break;
            case Constants::DT_NUMBER : $this->stream->writeDouble($data);
                break;
            case Constants::DT_STRING : $this->writeString($data);
                break;
            case Constants::DT_DATE : $this->writeDate($data);
                break;
            case Constants::DT_ARRAY : $this->writeArray($data);
                break;
            case Constants::DT_OBJECT : $this->writeObject($data);
                break;
            case Constants::DT_BYTEARRAY : $this->writeByteArray($data);
                break;
