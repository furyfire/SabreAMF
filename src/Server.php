...
class Server
{
    ...
    public function __construct()
    {
        ...
        $this->amfInputStream = new InputStream($data);
     ...
     * target parameter should contain the same as the 'response' item you got through getRequests. 
     * 
     * @param string $target This connects the request to the response
     * @param int $responsetype Set as either Constants::R_RESULT or Constants::R_STATUS
    ...
    public function setResponse($target, $responsetype, $data)
    {
        ...
        switch ($responsetype) {
            case Constants::R_RESULT:
                $target = $target.='/onResult';
                break;
            case Constants::R_STATUS:
                $target = $target.='/onStatus';
                break;
            case Constants::R_DEBUG:
    ...
    public function sendResponse()
    {
        ...
        header('Content-Type: ' . Constants::MIMETYPE);
     ...
     * @return bool
     */
    public static function setInputFile($stream)
    {
    ...
    protected function readInput()
    {
        ...
        if (is_null(self::$dataInputStream)) {
            return self::$dataInputData;
        }
