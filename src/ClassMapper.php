...
final class ClassMapper
{
     ...
     * @return void
     */
    public static function registerClass($remoteClass, $localClass)
    {
     ...
     * @return mixed 
     */
    public static function getLocalClass($remoteClass)
    {
     ...
     * @return mixed 
     */
    public static function getRemoteClass($localClass)
    {
